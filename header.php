...
<html>
<head>
	<title>Fidelia Bika Ambon</title>
		...
		<div class="row top">
			...
			<center>
				<div class="col-md-4" style="padding: 3px;">
					<span> <i class="glyphicon glyphicon-earphone"></i> +6281295251537</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> fidelia.bikambon@gmail.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span>Fidelia Bika Ambon</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#cc7722" style="color: #cc7722"><b>FIDELIA BIKA AMBON</b></a>
			</div>
