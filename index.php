...
<div class="container-fluid" style="margin: 0;padding: 0;">
	<div class="image" style="margin-top: -21px">
		<img src="image/home/BIKA.jpg" style="width: 100%;  height: 700px;">
	</div>
</div>
<br>
<br>
...
<div class="container">
		...
		<h4 class="text-center" style="font-family: arial; padding-top: 10px; padding-bottom: 10px; font-style: italic; line-height: 29px; border-top: 2px solid #cc7722; border-bottom: 2px solid #ff8d87;">Fidelia Bika Ambon adalah rantai toko roti legendaris BIKA AMBON yang tersebar di beberapa kota di Indonesia. Kami masih terus memperluas secara nasional ke kota-kota lain.</h4>


	<h2 style=" width: 100%; border-bottom: 4px solid #cc7722; margin-top: 80px;"><b>Produk Kami</b></h2>
